...
export default function ChooseRestaurant() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF9] flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-[#83560E]/5 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-6xl z-10 space-y-8 text-center">
        ...
        <div className="space-y-4">
          ...
          />
          <h1 className="text-3xl sm:text-4xl font-serif font-black text-[#83560E] tracking-tight">
            ...
            {restaurants.length === 0 ? (
              ...
              restaurants.map((r) => (
                <div
                  ...
                  className="bg-white border border-gray-150 rounded-3xl p-4 sm:p-5 text-left cursor-pointer transition-all hover:scale-[1.02] hover:shadow-xl hover:shadow-gray-100/70 hover:border-[#F8A324]/50 group relative overflow-hidden flex flex-col justify-between h-40 sm:h-44"
                >
                  <div className="flex items-start gap-3 sm:gap-4">
                    {r.logo ? (
                      <img src={r.logo} alt={r.name} className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl object-cover border border-gray-100" />
                    ) : (
                      <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-[#83560E]/5 flex items-center justify-center text-[#83560E] border border-gray-100 shrink-0">
                        <Store className="w-5 h-5 sm:w-6 sm:h-6" />
                      </div>
                    )}
                    <div className="space-y-1 min-w-0 flex-1">
                      <h3 className="font-serif font-black text-gray-800 text-sm sm:text-base leading-tight group-hover:text-[#83560E] transition-colors truncate">
                        {r.name}
                      </h3>
                  ...
                  <div className="border-t border-gray-50 pt-4 flex justify-between items-center">
                    <span className="text-[10px] text-[#83560E] font-extrabold uppercase tracking-widest">
                      Browse Menu
                    </span>
                    <div className="w-7 h-7 rounded-full bg-[#83560E]/5 flex items-center justify-center text-[#83560E] group-hover:bg-[#F8A324] group-hover:text-[#83560E] transition-all">
